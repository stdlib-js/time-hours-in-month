...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/time-hours-in-month/tags). For example,

```javascript
hoursInMonth = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/time-hours-in-month@v0.2.2-umd/browser.js' )
```
