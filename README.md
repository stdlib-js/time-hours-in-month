...
```javascript
import hoursInMonth from 'https://cdn.jsdelivr.net/gh/stdlib-js/time-hours-in-month@v0.2.3-esm/index.mjs';
```
...
[@stdlib/time/hours-in-year]: https://github.com/stdlib-js/time-hours-in-year/tree/esm
